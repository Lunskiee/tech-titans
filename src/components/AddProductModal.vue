...
// Function to completely reset form state back to initial default values
const resetForm = () => {
  form.value = {
    id: null,
    name: '',
...
// Function to remove/cancel only the uploaded image
const removeImage = () => {
...
// Function to handle closing and resetting
const handleClose = () => {
  resetForm()
  emit('close')
}

// Populate modal fields when opened for editing or reset for adding
